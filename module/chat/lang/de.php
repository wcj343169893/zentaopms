...
$lang->chat->url             = 'URL';
$lang->chat->pollingInterval = 'Polling interval';
$lang->chat->createKey       = 'New';
$lang->chat->connector       = ', ';
$lang->chat->viewDebug       = 'View Debug';
$lang->chat->log             = 'Log';
$lang->chat->xxdStatus       = 'XXD Status';
$lang->chat->debugInfo       = 'Debug';
$lang->chat->errorInfo       = 'Error';
$lang->chat->xxbConfigError  = 'XXB is error.';
$lang->chat->id              = 'ID';
...
$lang->chat->notInChat        = 'Unable to send message to unrelated chats.';
$lang->chat->notSameUser      = 'Unable to send message as someone else.';
$lang->chat->errorKey         = 'The key should be a 32 byte string including letters or numbers.';
$lang->chat->debugTips        = '<br>%s with administrator to get more information.';
...
$lang->chat->xxdPollIntTip  = 'Polling interval should be a number equal to or greater than 5, the default value is 60 for 60 seconds.';
$lang->chat->xxdPollIntErr  = 'Polling interval should be a number equal to or greater than 5.';
